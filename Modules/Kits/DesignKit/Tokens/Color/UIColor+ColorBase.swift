...
public extension Color {
    enum ChatView {
        ...
        /// Grayscale200, default value light color `#CCCCCC` and dark color `#525F66`
        public static let outgoingBubble = Color(lightColor: #colorLiteral(red: 0.4745098054, green: 0.8392156959, blue: 0.9764705896, alpha: 1), darkColor: #colorLiteral(red: 0, green: 0.4509803922, blue: 0.6666666667, alpha: 1))
    }
}
